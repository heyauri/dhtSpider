...
let db_metadata = level(metadata_path, {maxFileSize: 67108864, cacheSize: 34108864, writeBufferSize: 34108864});
let db_infohash = level(infohash_path, {maxFileSize: 67108864, cacheSize: 134108864, writeBufferSize: 134108864});
    ...
    indexToLog() {
        ...
        let stream = db_infohash.createReadStream()
            .pipe(through(function (data) {
                ...
                if(data.key.indexOf('001_') <0 && data.key.indexOf('002_') >-1 && data.key.indexOf('003_') < 0){
                    ...
                    this.queue(arr.length+"  "+JSON.stringify(data) + "\n");
                }
            }))
